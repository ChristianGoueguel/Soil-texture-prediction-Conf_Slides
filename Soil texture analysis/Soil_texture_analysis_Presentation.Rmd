...
- Soil texture is classified according to soil particle size
...
---
class: left, top
Principal component analysis (PCA) is performed on the spectral data at analytical area of 1 and 200 mm<sup>2</sup>.
...
Robust PCA (using ROBPCA algorithm<sup>[2]</sup>) is performed on the **spectra acquired on the 1 mm<sup>2</sup> area**. A diagnostic plot (outlier map) is produced. 
...
- Performance at analytical area of 1 and 200 mm<sup>2</sup> are compared
...
- Optical spectroscopy (e.g. LIBS) combined with chemometrics is a viable alternative to conventional methods for soils texture analysis
- PCA on the LIBS spectra reveals potential for classification of soil into three main groups of coarse, medium and fine textured soils.
- Partial least squares regression of LIBS spectra predict soil minerals fraction reliably
